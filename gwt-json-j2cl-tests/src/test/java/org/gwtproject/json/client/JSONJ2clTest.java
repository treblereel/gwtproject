...
//    for (int i = 0; i < 10; i++) {
//      assertEquals(
//          "Array value at " + i + " must be " + i, array.get(i).isNumber().doubleValue(), i, 0.001);
//    }
//  }
//
//  @Test
...
//    }
//    assertEquals(
//        "\"null\" should be null JSONValue", JSONNull.getInstance(), parseStrictVsLenient("null"));
//    assertEquals(
//        "5 should be JSONNumber 5", 5d, parseStrictVsLenient("5").isNumber().doubleValue(), 0.001);
//    assertEquals(
//        "\"null\" should be null JSONValue", JSONNull.getInstance(), parseStrictVsLenient("null"));
