...
public class TestServlet extends HttpServlet {
  ...
  private static final Set<String> CUSTOM_HEADERS =
      new HashSet<String>(Arrays.asList("header", "anotherheader"));
  ...
  private static final Set<String> METHODS =
      new HashSet<String>(Arrays.asList(METHOD_GET, METHOD_OPTIONS, METHOD_POST));
  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    response.getWriter().print("test content with body [" + requestBody + "]");
    response.setStatus(HttpServletResponse.SC_OK);
    response.getWriter().close();
  }
