...
public class JsonpRequestTest extends GWTTestCase {
  ...
  private String echoDelayed(String value, long delayMs) {
    return getPathToServer() + "echoServlet?action=SUCCESS&delay=" + delayMs + "&value=" + value;
  }
  ...
  public void testBooleanFalse() {
    ...
    jsonp.requestBoolean(echo("false"), new AssertSuccessCallback<Boolean>(Boolean.FALSE));
  }
  ...
  public void testObject() {
    ...
    jsonp.requestObject(
        ...
        // then
        new AssertObjectSuccessCallback(KeyValue.createKeyValue(key, value)));
  }
