...
public abstract class JSONValue {
   ...
   *
   * @return a reference to a JSONArray if this JSONValue is a JSONArray or <code>null</code>
   *     otherwise.
   */
   ...
   *
   * @return a reference to a JSONBoolean if this JSONValue is a JSONBoolean or <code>null</code>
   *     otherwise.
   */
   ...
   *
   * @return a reference to a JSONNull if this JSONValue is a JSONNull or <code>null</code>
   *     otherwise.
   */
   ...
   *
   * @return a reference to a JSONNumber if this JSONValue is a JSONNumber or <code>null</code>
   *     otherwise.
   */
   ...
   *
   * @return a reference to a JSONObject if this JSONValue is a JSONObject or <code>null</code>
   *     otherwise.
   */
   ...
   *
   * @return a reference to a JSONString if this JSONValue is a JSONString or <code>null</code>
   *     otherwise.
   */
  ...
  /**
   * Returns a JSON-encoded string for this entity. Use this method to create JSON strings that can
   * be sent from the client to a server.
   */
  @Override
  public abstract String toString();

  /** Internal. Returns a JS func that can unwrap this value. Used from native code. */
  abstract Object getUnwrapper();
}
