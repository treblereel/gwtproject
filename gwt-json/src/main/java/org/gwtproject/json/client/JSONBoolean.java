...
public class JSONBoolean extends JSONValue {
  ...
  /**
   * Gets a reference to the singleton instance representing either <code>true</code> or <code>false
   * </code>.
   *
   * @param b controls which value to get
   * @return if <code>true</code>, the JSONBoolean instance representing <code>true</code> is
   *     returned; otherwise, the JSONBoolean instance representing <code>false</code> is returned
   */
  ...
  /**
   * Returns <code>true</code> if this is the instance representing "true", <code>false</code>
   * otherwise.
   */
