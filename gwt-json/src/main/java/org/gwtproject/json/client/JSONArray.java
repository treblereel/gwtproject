...
public class JSONArray extends JSONValue {
   ...
   *
   * <p>use {@link #JSONArray(JsArray)} instead
   *
  ...
  /**
   * Returns <code>true</code> if <code>other</code> is a {@link JSONArray} wrapping the same
   * underlying object.
   */
  @Override
   ...
   * @return the value at this index, or <code>null</code> if this index is empty
   */
   ...
   * @return the previous value at this index, or <code>null</code> if this index was empty
   */
  ...
  /**
   * Create the JSON encoded string representation of this JSONArray instance. This method may take
   * a long time to execute if the underlying array is large.
   */
  @Override
  ...
  private void set0(int index, JSONValue value) {
    ...
    if (Objects.isNull(value)) unwrappedValue = Js.undefined();
    else unwrappedValue = value.getUnwrapper();
