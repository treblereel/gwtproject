...
public class JSONJ2clTest {
  ...
  private static void assertJSONObjectEquals(JSONObject expected, JSONObject actual) {
  ...
  //    assertNotNull("v must be an array", array);
  //    assertEquals("Array size must be 10", 10, array.size());
  //    for (int i = 0; i < 10; i++) {
  //      assertEquals(
  //          "Array value at " + i + " must be " + i, array.get(i).isNumber().doubleValue(), i, 0);
  //    }
  //  }
  ...
  //    for (int i = 0; i < 10; i++) {
  //      assertEquals(
  //          "Object value at 'Object " + i + "' must be " + i,
  //          objIn.get("Object " + i).isNumber().doubleValue(),
  //          i,
  //          0.001);
  //    }
  //  }
  ...
  //    }
  //    assertEquals(
  //        "\"null\" should be null JSONValue", JSONNull.getInstance(),
  // parseStrictVsLenient("null"));
  //    assertEquals(
  //        "5 should be JSONNumber 5", 5d, parseStrictVsLenient("5").isNumber().doubleValue(),
  // 0.001);
  //    assertEquals(
  //        "\"null\" should be null JSONValue", JSONNull.getInstance(),
  // parseStrictVsLenient("null"));
  ...
  //    assertTrue(
  //        "somethingHello element 0 must have hello for key something",
  //        somethingHelloObject.get("something").isString().stringValue().equals("hello"));
  //  }

  //// TODO temporarely out comment due to a possibble bug in htmlunit. Runs in browser!
  ////  @Test
  ...
  private void assertHashCodeEquals(Object expected, Object actual) {
    assertEquals("hashCodes are not equal", expected.hashCode(), actual.hashCode());
  }
  ...
  private void doTestParseUnescaped(int start, int len) {
    ...
    DomGlobal.window.console.log(sb.toString());
