...
import org.gwtproject.validation.example.client.ExampleValidatorFactory.ClientGroup;
import org.gwtproject.validation.example.client.ExampleValidatorFactory.ServerGroup;

/**
 * Tests for {@link Author}.
 */
@J2clTestInput(value = AuthorTest.class)
public class AuthorTest extends GWTTestCase {
    ...
    public String getModuleName() {
        return "org.gwtproject.validation.example.ValidationExample";
    }
    ...
    protected final void gwtSetUp() throws Exception {
        super.gwtSetUp();
        author = new Author();
        validator = new ExampleValidatorFactory_GwtValidatorImpl();
    }
