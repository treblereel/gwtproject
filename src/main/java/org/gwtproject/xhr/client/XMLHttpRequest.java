...
public class XMLHttpRequest {
    ...
    public enum ResponseType {
         ...
         * {@link org.gwtproject.typedarrays.shared.TypedArrays#isSupported()}
         * returns true.
         */
    ...
    */
     ...
     * @param password   password to use in the URL
     */
    public final native void open(String httpMethod, String url, boolean async, String user, String password);
