...
class JsHelper {
  ...
  public static NativeDocumentImpl createDocumentImpl() {
    return Js.<Fn>uncheckedCast(Js.asPropertyMap(Js.asPropertyMap(DomGlobal.document)
                                                         .get("implementation"))
                                        .get("createDocument"))
            .onInvoke("", "", null);
  }
  ...
  @JsFunction
  public interface Fn {
    NativeDocumentImpl onInvoke(String namespaceURI, String qualifiedNameStr, String documentType);
  }
