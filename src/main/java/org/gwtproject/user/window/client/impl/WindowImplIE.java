 ...
 * the License.
 */
package org.gwtproject.user.window.client.impl;
...
/**
 * IE implementation of {@link org.gwtproject.user.window.client.impl.WindowImpl}.
 */
public class WindowImplIE extends WindowImpl {
  ...
  private native void initWindowCloseHandlerImpl() /*-{
    $wnd.__gwt_initWindowCloseHandler(
      $entry(@org.gwtproject.user.window.client.Window::onClosing()),
      $entry(@org.gwtproject.user.window.client.Window::onClosed())
    );
  }-*/;

  private native void initWindowResizeHandlerImpl() /*-{
    $wnd.__gwt_initWindowResizeHandler(
      $entry(@org.gwtproject.user.window.client.Window::onResize())
    );
  }-*/;

  private native void initWindowScrollHandlerImpl() /*-{
    $wnd.__gwt_initWindowScrollHandler(
      $entry(@org.gwtproject.user.window.client.Window::onScroll())
    );
  }-*/;
