 ...
 * 
 * @see org.gwtproject.user.window.client.Window#addWindowScrollListener(WindowScrollListener)
 * @deprecated use
 *             {@link Window#addWindowScrollHandler(org.gwtproject.user.window.client.Window.ScrollHandler)}
 *             instead instead
 */
@Deprecated
