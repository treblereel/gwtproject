...
public class JSONNumber extends JSONValue {
  ...
  public native String toString() /*-{
    ...
    return this.@com.progressoft.brix.domino.json.client.JSONNumber::value + "";
  }-*/;

  @Override
  native JavaScriptObject getUnwrapper() /*-{
    return @com.progressoft.brix.domino.json.client.JSONNumber::unwrap(Lcom/progressoft/brix/domino/json/client/JSONNumber;);
  }-*/;
}
