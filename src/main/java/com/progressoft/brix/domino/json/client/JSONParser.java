...
public class JSONParser {
  ...
  private static native JSONValue createObject(Object o) /*-{
    if (!o) {
      return @com.progressoft.brix.domino.json.client.JSONNull::getInstance()();
    }
    ...
    if (v !== o) {
      ...
      // in all cases.
      return @com.progressoft.brix.domino.json.client.JSONArray::new(Lcom/google/gwt/core/client/JavaScriptObject;)(o);
    } else {
      // This is a basic JavaScript object; wrap as JSONObject.
      // Subobjects will be created on demand.
      return @com.progressoft.brix.domino.json.client.JSONObject::new(Lcom/google/gwt/core/client/JavaScriptObject;)(o);
    }
  }-*/;
  ...
  private static native JSONValue evaluate(String json, boolean strict) /*-{
    ...
    if (strict) {
      try {
        ...
        return @com.progressoft.brix.domino.json.client.JSONParser::throwJSONException(Ljava/lang/String;)("Error parsing JSON: " + e);
      }
    } else {
  ...
  private static native JavaScriptObject initTypeMap() /*-{
    return {
      "boolean": @com.progressoft.brix.domino.json.client.JSONParser::createBoolean(Z),
      "number": @com.progressoft.brix.domino.json.client.JSONParser::createNumber(D),
      "string": @com.progressoft.brix.domino.json.client.JSONParser::createString(Ljava/lang/String;),
      "object": @com.progressoft.brix.domino.json.client.JSONParser::createObject(Ljava/lang/Object;),
      "function": @com.progressoft.brix.domino.json.client.JSONParser::createObject(Ljava/lang/Object;),
      "undefined": @com.progressoft.brix.domino.json.client.JSONParser::createUndefined(),
    }
  }-*/;
