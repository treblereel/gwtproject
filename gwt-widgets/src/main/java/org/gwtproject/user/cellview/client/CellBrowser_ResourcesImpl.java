...
public class CellBrowser_ResourcesImpl implements CellBrowser.Resources {
  ...
  private void cellBrowserClosedInitializer() {
    cellBrowserClosed = new org.gwtproject.resources.client.impl.ImageResourcePrototype(
      "cellBrowserClosed",
  ...
  private void cellBrowserOpenInitializer() {
    cellBrowserOpen = new org.gwtproject.resources.client.impl.ImageResourcePrototype(
      "cellBrowserOpen",
  ...
  private void cellBrowserOpenBackgroundInitializer() {
    cellBrowserOpenBackground = new org.gwtproject.resources.client.impl.ImageResourcePrototype(
  ...
  private void cellBrowserSelectedBackgroundInitializer() {
    cellBrowserSelectedBackground = new org.gwtproject.resources.client.impl.ImageResourcePrototype(
  ...
  private void cellBrowserStyleInitializer() {
    cellBrowserStyle = new CellBrowser.Style() {
      ...
      public String getText() {
        return (".MU1SOAB-h-b,.MU1SOAB-h-e{padding:8px;zoom:1}.MU1SOAB-h-d{background:#ffc}.MU1SOAB-h-g{background:url(" + (CellBrowser_ResourcesImpl.this.cellBrowserSelectedBackground().getSafeUri().asString()) + ") " + ("-" + CellBrowser_ResourcesImpl.this.cellBrowserSelectedBackground().getLeft() + "px") + " " + ("-" + CellBrowser_ResourcesImpl.this.cellBrowserSelectedBackground().getTop() + "px") + "  repeat;background-color:#628cd5;background-repeat:repeat-x;color:white;height:auto;overflow:hidden}.MU1SOAB-h-f{background:url(" + (CellBrowser_ResourcesImpl.this.cellBrowserOpenBackground().getSafeUri().asString()) + ") " + ("-" + CellBrowser_ResourcesImpl.this.cellBrowserOpenBackground().getLeft() + "px") + " " + ("-" + CellBrowser_ResourcesImpl.this.cellBrowserOpenBackground().getTop() + "px") + "  repeat;background-color:#7b7b7b;background-repeat:repeat-x;color:white;height:auto;overflow:hidden}");
      }
  ...
  private static final String externalImage = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAAAWElEQVR4XmNgGAUYICws7H92Ts5/dHGigYODw38HR8f/ZBsE0oyMYQZNmDCBOMNAmhxBmoEuAdNQ7OTsTJxBMA1wzVAvgfhEGYCukWQvwAwgOxDJ1jiCAQD3hlZxsqImSwAAAABJRU5ErkJggg==";
  private static final String externalImage0 = "data:image/gif;base64,R0lGODlhEAAQAOMIAEBAQEBBQUFBQUFCQ1NVVXd3d9PT0////wAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAACH5BAEAAAgALAAAAAAQABAAAAQ2EMlJq704W3OOnkfBedohBMSYHQAQoKp1vIErDARJzadwojpQ4JfqXEyAYrASimWcn6h0WokAADs=";
  private static final String externalImage1 = "data:image/png;base64,";
