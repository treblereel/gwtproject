...
public class CellTree_ResourcesImpl implements CellTree.Resources {
  ...
  private void cellTreeStyleInitializer() {
    cellTreeStyle = new CellTree.Style() {
