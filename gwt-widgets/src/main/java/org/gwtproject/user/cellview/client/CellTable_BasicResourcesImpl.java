...
public class CellTable_BasicResourcesImpl implements CellTable.BasicResources {
  ...
  private void cellTableFooterBackgroundInitializer() {
    cellTableFooterBackground = new org.gwtproject.resources.client.impl.ImageResourcePrototype(
  ...
  private void cellTableHeaderBackgroundInitializer() {
    cellTableHeaderBackground = new org.gwtproject.resources.client.impl.ImageResourcePrototype(
  ...
  private void cellTableLoadingInitializer() {
    cellTableLoading = new org.gwtproject.resources.client.impl.ImageResourcePrototype(
      "cellTableLoading",
  ...
  private void cellTableSelectedBackgroundInitializer() {
    cellTableSelectedBackground = new org.gwtproject.resources.client.impl.ImageResourcePrototype(
  ...
  private void cellTableSortAscendingInitializer() {
    cellTableSortAscending = new org.gwtproject.resources.client.impl.ImageResourcePrototype(
  ...
  private void cellTableSortDescendingInitializer() {
    cellTableSortDescending = new org.gwtproject.resources.client.impl.ImageResourcePrototype(
  ...
  private void cellTableStyleInitializer() {
    cellTableStyle = new CellTable.BasicStyle() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? (".MU1SOAB-c-g{height:" + (CellTable_BasicResourcesImpl.this.cellTableFooterBackground().getHeight() + "px") + ";background:url(" + (CellTable_BasicResourcesImpl.this.cellTableFooterBackground().getSafeUri().asString()) + ") " + ("-" + CellTable_BasicResourcesImpl.this.cellTableFooterBackground().getLeft() + "px") + " " + ("-" + CellTable_BasicResourcesImpl.this.cellTableFooterBackground().getTop() + "px") + "  repeat-x;background-color:#b4d0f8;border-top:1px solid #88b0f2;border-right:1px solid #88b0f2;border-left:1px solid #eef;padding:0 10px;text-align:right;color:#4b4a4a;text-shadow:#ddf 1px 1px 0;overflow:hidden}.MU1SOAB-c-h{height:" + (CellTable_BasicResourcesImpl.this.cellTableHeaderBackground().getHeight() + "px") + ";background:url(" + (CellTable_BasicResourcesImpl.this.cellTableHeaderBackground().getSafeUri().asString()) + ") " + ("-" + CellTable_BasicResourcesImpl.this.cellTableHeaderBackground().getLeft() + "px") + " " + ("-" + CellTable_BasicResourcesImpl.this.cellTableHeaderBackground().getTop() + "px") + "  repeat-x;background-color:#b4d0f8;border-bottom:1px solid #88b0f2;border-right:1px solid #88b0f2;border-left:1px solid #eef;padding:0 10px;text-align:right;color:#4b4a4a;text-shadow:#ddf 1px 1px 0;overflow:hidden}.MU1SOAB-c-a{padding:4px 10px;overflow:hidden}.MU1SOAB-c-e,.MU1SOAB-c-f{border-right:0}.MU1SOAB-c-v{cursor:pointer;cursor:hand}.MU1SOAB-c-v:hover{color:#6c6b6b}.MU1SOAB-c-b{background:#fff}.MU1SOAB-c-r{background:#eef4fb}.MU1SOAB-c-i{background:#eee}.MU1SOAB-c-l{background:#ffc}.MU1SOAB-c-t{background:url(" + (CellTable_BasicResourcesImpl.this.cellTableSelectedBackground().getSafeUri().asString()) + ") " + ("-" + CellTable_BasicResourcesImpl.this.cellTableSelectedBackground().getLeft() + "px") + " ") + (("-" + CellTable_BasicResourcesImpl.this.cellTableSelectedBackground().getTop() + "px") + "  repeat-x;background-color:#628cd5;color:white;height:auto;overflow:auto}.MU1SOAB-c-u{background:#628cd5}.MU1SOAB-c-k{background:#d7dde8}.MU1SOAB-c-q{margin:30px}") : (".MU1SOAB-c-g{height:" + (CellTable_BasicResourcesImpl.this.cellTableFooterBackground().getHeight() + "px") + ";background:url(" + (CellTable_BasicResourcesImpl.this.cellTableFooterBackground().getSafeUri().asString()) + ") " + ("-" + CellTable_BasicResourcesImpl.this.cellTableFooterBackground().getLeft() + "px") + " " + ("-" + CellTable_BasicResourcesImpl.this.cellTableFooterBackground().getTop() + "px") + "  repeat-x;background-color:#b4d0f8;border-top:1px solid #88b0f2;border-left:1px solid #88b0f2;border-right:1px solid #eef;padding:0 10px;text-align:left;color:#4b4a4a;text-shadow:#ddf 1px 1px 0;overflow:hidden}.MU1SOAB-c-h{height:" + (CellTable_BasicResourcesImpl.this.cellTableHeaderBackground().getHeight() + "px") + ";background:url(" + (CellTable_BasicResourcesImpl.this.cellTableHeaderBackground().getSafeUri().asString()) + ") " + ("-" + CellTable_BasicResourcesImpl.this.cellTableHeaderBackground().getLeft() + "px") + " " + ("-" + CellTable_BasicResourcesImpl.this.cellTableHeaderBackground().getTop() + "px") + "  repeat-x;background-color:#b4d0f8;border-bottom:1px solid #88b0f2;border-left:1px solid #88b0f2;border-right:1px solid #eef;padding:0 10px;text-align:left;color:#4b4a4a;text-shadow:#ddf 1px 1px 0;overflow:hidden}.MU1SOAB-c-a{padding:4px 10px;overflow:hidden}.MU1SOAB-c-e,.MU1SOAB-c-f{border-left:0}.MU1SOAB-c-v{cursor:pointer;cursor:hand}.MU1SOAB-c-v:hover{color:#6c6b6b}.MU1SOAB-c-b{background:#fff}.MU1SOAB-c-r{background:#eef4fb}.MU1SOAB-c-i{background:#eee}.MU1SOAB-c-l{background:#ffc}.MU1SOAB-c-t{background:url(" + (CellTable_BasicResourcesImpl.this.cellTableSelectedBackground().getSafeUri().asString()) + ") " + ("-" + CellTable_BasicResourcesImpl.this.cellTableSelectedBackground().getLeft() + "px") + " ") + (("-" + CellTable_BasicResourcesImpl.this.cellTableSelectedBackground().getTop() + "px") + "  repeat-x;background-color:#628cd5;color:white;height:auto;overflow:auto}.MU1SOAB-c-u{background:#628cd5}.MU1SOAB-c-k{background:#d7dde8}.MU1SOAB-c-q{margin:30px}");
      }
