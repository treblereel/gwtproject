...
public class SelectionChangeEvent extends Event<SelectionChangeEvent.Handler> {
  ...
  /** Interface specifying that a class can add {@code SelectionChangeEvent.Handler}s. */
  ...
  /**
   * Fires a selection change event on all registered handlers in the handler manager. If no such
