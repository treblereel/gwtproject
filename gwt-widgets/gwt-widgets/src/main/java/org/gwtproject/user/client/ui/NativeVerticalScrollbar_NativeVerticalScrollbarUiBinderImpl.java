...
public class NativeVerticalScrollbar_NativeVerticalScrollbarUiBinderImpl
    implements org.gwtproject.uibinder.client.UiBinder<
            org.gwtproject.dom.client.Element,
            org.gwtproject.user.client.ui.NativeVerticalScrollbar>,
        org.gwtproject.user.client.ui.NativeVerticalScrollbar.NativeVerticalScrollbarUiBinder {
  ...
  Template template =
      new NativeVerticalScrollbar_NativeVerticalScrollbarUiBinderImpl_TemplateImpl();

  public org.gwtproject.dom.client.Element createAndBindUi(
      final org.gwtproject.user.client.ui.NativeVerticalScrollbar owner) {
  ...
  class Widgets {
    ...
    org.gwtproject.safehtml.shared.SafeHtml template_html1() {
      return template.html1(
          "" + get_res().nativeVerticalScrollbarUi().viewport() + "",
          "" + get_res().nativeVerticalScrollbarUi().scrollable() + "",
          get_domId0(),
          get_domId1());
    }
    ...
    private org.gwtproject.user.client.ui
            .NativeVerticalScrollbar_NativeVerticalScrollbarUiBinderImpl_GenBundle
      ...
      final org.gwtproject.user.client.ui
          ...
          clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay =
              new org.gwtproject.user.client.ui
                  .NativeVerticalScrollbar_NativeVerticalScrollbarUiBinderImpl_GenBundleImpl();
      // Setup section.
