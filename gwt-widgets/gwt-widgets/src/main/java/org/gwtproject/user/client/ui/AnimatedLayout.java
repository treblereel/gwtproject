 ...
 *
 * <p>The normal use pattern is to set all childrens' positions, then to call {@link #animate(int)}
...
public interface AnimatedLayout {
   ...
   * Layout children, animating over the specified period of time.
   *
   * <p>This method provides a callback that will be informed of animation updates. This can be used
   * to create more complex animation effects.
   *
   * @param duration the animation duration, in milliseconds
   ...
   *
   * <p>This is not normally necessary, unless you want to update child widgets' positions
   * explicitly to create a starting point for a subsequent call to {@link #animate(int)}.
   *
   * @see #animate(int)
