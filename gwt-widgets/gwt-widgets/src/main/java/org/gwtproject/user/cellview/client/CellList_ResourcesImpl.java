...
public class CellList_ResourcesImpl implements CellList.Resources {
    ...
    cellListStyle =
        new CellList.Style() {
          ...
          public String getText() {
            return (".MU1SOAB-g-a,.MU1SOAB-g-c{cursor:pointer;zoom:1}.MU1SOAB-g-b{background:#ffc}.MU1SOAB-g-d{background:url("
                + (CellList_ResourcesImpl.this.cellListSelectedBackground().getSafeUri().asString())
                + ") "
                + ("-" + CellList_ResourcesImpl.this.cellListSelectedBackground().getLeft() + "px")
                + " "
                + ("-" + CellList_ResourcesImpl.this.cellListSelectedBackground().getTop() + "px")
                + "  repeat-x;background-color:#628cd5;color:white;height:auto;overflow:visible}");
          }
  ...
  public ResourcePrototype[] getResources() {
    return new ResourcePrototype[] {
      cellListSelectedBackground(), cellListStyle(),
    };
  }
