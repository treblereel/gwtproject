...
public class NativeHorizontalScrollbar_ResourcesImpl
    implements NativeHorizontalScrollbar.Resources {
  private static NativeHorizontalScrollbar_ResourcesImpl _instance0 =
      new NativeHorizontalScrollbar_ResourcesImpl();
