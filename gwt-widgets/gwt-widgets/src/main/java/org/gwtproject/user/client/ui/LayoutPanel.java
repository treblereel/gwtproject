 ...
 *
 * <p>LayoutPanel elements in {@link org.gwtproject.uibinder.client.UiBinder UiBinder} templates lay
 * out their children with arbitrary constraints, using &lt;g:layer> elements. Each layer may have
 * any of the following constraint attributes specified as CSS length attributes: <code>left</code>,
 * <code>top</code>, <code>right</code>, <code>bottom</code>, <code>width</code> , and <code>height
 * </code>.
 *
 * <p>Precisely zero or two constraints are required for each axis (horizontal and vertical).
 * Specifying no constraints implies that the child should fill that axis completely.
 *
 * <p>The valid sets of horizontal constraints are:
 *
 * <dl>
 *   <dt>(none)
 ...
 * </dl>
 *
 * <p>The valid sets of vertical constraints are:
 *
 * <dl>
 *   <dt>(none)
 ...
 * </dl>
 *
 * <p>The values of constraint attributes can be any valid <a
 * href='http://www.w3.org/TR/CSS21/syndata.html#length-units'>CSS length</a>, such as <code>1px
 * </code>, <code>3em</code>, or <code>0</code> (zero lengths require no units).
 *
 * <p>For example:
 *
 * <pre>
 ...
 * </pre>
 */
public class LayoutPanel extends ComplexPanel
   ...
   * @param heightUnit
   */
  public void setWidgetBottomHeight(
      Widget child, double bottom, Unit bottomUnit, double height, Unit heightUnit) {
    assertIsChild(child);
   ...
   */
  public void setWidgetBottomHeight(
      IsWidget child, double bottom, Unit bottomUnit, double height, Unit heightUnit) {
   ...
   * @param rightUnit
   */
  public void setWidgetLeftRight(
      Widget child, double left, Unit leftUnit, double right, Unit rightUnit) {
    assertIsChild(child);
   ...
   */
  public void setWidgetLeftRight(
      IsWidget child, double left, Unit leftUnit, double right, Unit rightUnit) {
   ...
   * @param widthUnit
   */
  public void setWidgetLeftWidth(
      Widget child, double left, Unit leftUnit, double width, Unit widthUnit) {
    assertIsChild(child);
   ...
   */
  public void setWidgetLeftWidth(
      IsWidget child, double left, Unit leftUnit, double width, Unit widthUnit) {
   ...
   * @param widthUnit
   */
  public void setWidgetRightWidth(
      Widget child, double right, Unit rightUnit, double width, Unit widthUnit) {
    assertIsChild(child);
   ...
   */
  public void setWidgetRightWidth(
      IsWidget child, double right, Unit rightUnit, double width, Unit widthUnit) {
   ...
   * @param bottomUnit
   */
  public void setWidgetTopBottom(
      Widget child, double top, Unit topUnit, double bottom, Unit bottomUnit) {
    assertIsChild(child);
   ...
   */
  public void setWidgetTopBottom(
      IsWidget child, double top, Unit topUnit, double bottom, Unit bottomUnit) {
   ...
   * @param heightUnit
   */
  public void setWidgetTopHeight(
      Widget child, double top, Unit topUnit, double height, Unit heightUnit) {
    assertIsChild(child);
   ...
   */
  public void setWidgetTopHeight(
      IsWidget child, double top, Unit topUnit, double height, Unit heightUnit) {
  ...
  /**
   * Shows or hides the given widget and its layer. This method explicitly calls {@link
   * UIObject#setVisible(boolean)} on the child widget and ensures that its associated layer is
   * shown/hidden.
   *
   * @param child
   * @param visible
  ...
  /**
   * Gets the {@link Layout} instance associated with this widget. This is made package-protected
   * for use by {@link RootLayoutPanel}.
   *
