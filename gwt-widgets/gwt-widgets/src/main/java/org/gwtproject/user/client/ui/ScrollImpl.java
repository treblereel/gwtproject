...
class ScrollImpl {
  ...
  /**
   * Check if the specified element has an RTL direction. We can't base this on the current locale
   * because the user can modify the direction at the DOM level.
   *
   * @param scrollable the scrollable element
