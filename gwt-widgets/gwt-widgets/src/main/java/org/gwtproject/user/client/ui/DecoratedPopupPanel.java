...
/**
 * A {@link PopupPanel} that wraps its content in a 3x3 grid, which allows users to add rounded
 * corners.
 *
 * <h3>Setting the Size:</h3>
 *
 * <p>If you set the width or height of the {@link DecoratedPopupPanel}, you need to set the height
 * and width of the middleCenter cell to 100% so that the middleCenter cell takes up all of the
 * available space. If you do not set the width and height of the {@link DecoratedPopupPanel}, it
 * will wrap its contents tightly.
 *
 * <pre>
 ...
 *
 * <ul class='css'>
 *   <li>.gwt-DecoratedPopupPanel { the outside of the popup }
 *   <li>.gwt-DecoratedPopupPanel .popupContent { the wrapper around the content }
 *   <li>.gwt-DecoratedPopupPanel .popupTopLeft { the top left cell }
 *   <li>.gwt-DecoratedPopupPanel .popupTopLeftInner { the inner element of the cell }
 *   <li>.gwt-DecoratedPopupPanel .popupTopCenter { the top center cell }
 *   <li>.gwt-DecoratedPopupPanel .popupTopCenterInner { the inner element of the cell }
 *   <li>.gwt-DecoratedPopupPanel .popupTopRight { the top right cell }
 *   <li>.gwt-DecoratedPopupPanel .popupTopRightInner { the inner element of the cell }
 *   <li>.gwt-DecoratedPopupPanel .popupMiddleLeft { the middle left cell }
 *   <li>.gwt-DecoratedPopupPanel .popupMiddleLeftInner { the inner element of the cell }
 *   <li>.gwt-DecoratedPopupPanel .popupMiddleCenter { the middle center cell }
 *   <li>.gwt-DecoratedPopupPanel .popupMiddleCenterInner { the inner element of the cell }
 *   <li>.gwt-DecoratedPopupPanel .popupMiddleRight { the middle right cell }
 *   <li>.gwt-DecoratedPopupPanel .popupMiddleRightInner { the inner element of the cell }
 *   <li>.gwt-DecoratedPopupPanel .popupBottomLeft { the bottom left cell }
 *   <li>.gwt-DecoratedPopupPanel .popupBottomLeftInner { the inner element of the cell }
 *   <li>.gwt-DecoratedPopupPanel .popupBottomCenter { the bottom center cell }
 *   <li>.gwt-DecoratedPopupPanel .popupBottomCenterInner { the inner element of the cell }
 *   <li>.gwt-DecoratedPopupPanel .popupBottomRight { the bottom right cell }
 *   <li>.gwt-DecoratedPopupPanel .popupBottomRightInner { the inner element of the cell }
 * </ul>
 */
