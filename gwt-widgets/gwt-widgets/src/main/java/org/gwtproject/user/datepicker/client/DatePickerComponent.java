...
/**
 * Package protected class used to combine functionality for the {@link MonthSelector} and {@link
...
abstract class DatePickerComponent extends Composite {
  ...
  /**
   * Refresh the component. Usually called because the model's current date has changed. In general,
   * only should be called by {@link DatePicker}. Use refreshAll() if you need to refresh all
   * components.
   */
  protected abstract void refresh();

  /** Refreshes the {@link DatePicker}, {@link CalendarView}, and {@link CalendarModel}. */
