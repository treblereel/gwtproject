 ...
 *
 * <p>The names of the static members of {@link VerticalAlignmentConstant}, as well as simple
 * alignment names (<code>top</code>, <code>middle</code>, <code>bottom</code>), can be used as
 * values for a <code>verticalAlignment</code> attribute of any widget that implements this
...
public interface HasVerticalAlignment {
  ...
  VerticalAlignmentConstant ALIGN_BOTTOM = new VerticalAlignmentConstant("bottom");

  /** Specifies that the widget's contents should be aligned in the middle. */
  VerticalAlignmentConstant ALIGN_MIDDLE = new VerticalAlignmentConstant("middle");
   ...
   *
   * @param align the vertical alignment ( {@link HasVerticalAlignment#ALIGN_TOP}, {@link
   *     HasVerticalAlignment#ALIGN_MIDDLE}, or {@link HasVerticalAlignment#ALIGN_BOTTOM}).
   */
