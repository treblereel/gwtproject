 ...
 *
 * <p>DockLayoutPanel elements in {@link org.gwtproject.uibinder.client.UiBinder UiBinder} templates
 * lay out their children in elements tagged with the cardinal directions, and center:
 *
 * <p>
 *
 * <dl>
 ...
 * </dl>
 *
 * <p>Each child can hold only widget, and there can be only one &lt;g:center>. However, there can
 * be any number of the directional children.
 *
 * <p>(Note that the tags of the child elements are not capitalized. This is meant to signal that
 * they are not runtime objects, and so cannot have a <code>ui:field</code> attribute.)
 *
 * <p>For example:
 *
 * <pre>
...
public class DockLayoutPanel extends ComplexPanel
  ...
  /**
   * Used in {@link DockLayoutPanel#addEast(Widget, double)} et al to specify the direction in which
   * a child widget will be added.
   */
  ...
  /**
   * Adds a widget to the end of the line. In LTR mode, the widget is added to the east. In RTL
   * mode, the widget is added to the west.
   *
   * @param widget the widget to be added
   * @param size the child widget's size
   */
  ...
  /**
   * Adds a widget to the start of the line. In LTR mode, the widget is added to the west. In RTL
   * mode, the widget is added to the east.
   *
   * @param widget the widget to be added
   * @param size the child widget's size
   */
  ...
  /**
   * Adds a widget to the start of the line, inserting it before an existing widget. In LTR mode,
   * the widget is added to the east. In RTL mode, the widget is added to the west.
   *
   * @param widget the widget to be added
   * @param size the child widget's size
   * @param before the widget before which to insert the new child, or <code>null</code> to append
  ...
  /**
   * Adds a widget to the end of the line, inserting it before an existing widget. In LTR mode, the
   * widget is added to the west. In RTL mode, the widget is added to the east.
   *
   * @param widget the widget to be added
   * @param size the child widget's size
   * @param before the widget before which to insert the new child, or <code>null</code> to append
  ...
  /**
   * Updates the size of the widget passed in as long as it is not the center widget and updates the
   * layout of the dock.
   *
  ...
  /**
   * Resolve the specified direction based on the current locale. If the direction is {@link
   * Direction#LINE_START} or {@link Direction#LINE_END}, the return value will be one of {@link
   * Direction#EAST} or {@link Direction#WEST} depending on the RTL mode of the locale. For all
