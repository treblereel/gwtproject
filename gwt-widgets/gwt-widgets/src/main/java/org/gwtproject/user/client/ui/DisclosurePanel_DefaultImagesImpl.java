...
public class DisclosurePanel_DefaultImagesImpl implements org.gwtproject.user.client.ui.DisclosurePanel.DefaultImages {
  ...
  private void disclosurePanelClosedInitializer() {
    disclosurePanelClosed = new org.gwtproject.resources.client.impl.ImageResourcePrototype(
  ...
  private void disclosurePanelOpenInitializer() {
    disclosurePanelOpen = new org.gwtproject.resources.client.impl.ImageResourcePrototype(
      "disclosurePanelOpen",
