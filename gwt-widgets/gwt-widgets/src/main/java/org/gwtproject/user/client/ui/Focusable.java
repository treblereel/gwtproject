...
public interface Focusable {
   ...
   *
   * <p>NOTE: Most browsers fire FocusEvents asynchronously. Especially within GWT tests, you'll
   * need to make your test asynchronous to properly do verifications. See {@code
   * GWTTestCase#delayTestFinish} for more information on how to do this.
   *
