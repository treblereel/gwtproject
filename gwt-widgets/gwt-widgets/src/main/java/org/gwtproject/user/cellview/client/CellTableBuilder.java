 ...
 *
 * <p>The default implementation used by cell widths is {@link
 * org.gwtproject.user.cellview.client.DefaultCellTableBuilder}.
 *
...
public interface CellTableBuilder<T> {
  ...
  /**
   * Finish the building of rows and return the table section builder. Currently only {@link
   * org.gwtproject.dom.builder.shared.HtmlTableSectionBuilder} and its subclasses are supported.
   */
