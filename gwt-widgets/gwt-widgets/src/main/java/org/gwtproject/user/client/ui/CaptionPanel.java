...
public class CaptionPanel extends Composite implements HasWidgets.ForIsWidget {
  ...
  public static class CaptionPanelImplMozilla extends CaptionPanelImpl {
    @Override
    public void setCaption(final FieldSetElement fieldset, Element legend, SafeHtml caption) {
      setCaption(fieldset, legend, caption.asString(), true);
    }
   ...
   * @param asHTML if <code>true</code>, the <code>caption</code> param is interpreted as HTML;
   *     otherwise, <code>caption</code> is treated as text and automatically escaped
   */
  ...
  /**
   * Returns the caption as HTML; note that if the caption was previously set using {@link
  ...
  /**
   * Returns the caption as text; note that if the caption was previously set using {@link
   ...
   *
   * @return the content widget specified previously in {@link #setContentWidget(Widget)}
   */
  ...
  /**
   * Removes the specified widget, although in practice the specified widget must be the content
   * widget.
   *
   * @param w the widget to remove; note that anything other than the Widget returned by {@link
   *     #getContentWidget()} will have no effect
   */
  ...
  /**
   * Sets the caption for the panel using an HTML fragment. Pass in empty string to remove the
   * caption completely, leaving just the unadorned panel.
   *
  ...
  /**
   * Sets the caption for the panel using text that will be automatically escaped. Pass in empty
   * string to remove the caption completely, leaving just the unadorned panel.
   *
