 ...
 *
 * <p>The names of the static members of {@link HorizontalAlignmentConstant}, as well as simple
 * alignment names (<code>left</code>, <code>center</code>, <code>right</code>, <code>justify</code>
 * ), can be used as values for a <code>horizontalAlignment</code> attribute of any widget that
 * implements this interface. (In fact, this will work for any widget method that takes a single
...
public interface HasHorizontalAlignment {
  ...
  /**
   * Type for values defined and used in {@link HasAutoHorizontalAlignment}. Defined here so that
   * HorizontalAlignmentConstant can be derived from it, thus allowing HasAutoHorizontalAlignment
   * methods to accept and return both AutoHorizontalAlignmentConstant and
   * HorizontalAlignmentConstant values - without allowing the methods defined here to accept or
   * return AutoHorizontalAlignmentConstant values.
   */
  ...
  /**
   * Possible return values for {@link #getHorizontalAlignment}, and parameter values for {@link
   ...
   *
   * @return the current horizontal alignment ( {@link HasHorizontalAlignment#ALIGN_LEFT}, {@link
   *     HasHorizontalAlignment#ALIGN_CENTER}, {@link HasHorizontalAlignment#ALIGN_RIGHT}, {@link
   *     HasHorizontalAlignment#ALIGN_JUSTIFY}, or null).
   */
   ...
   *
   * <p>Use {@code null} to clear horizontal alignment, allowing it to be determined by the standard
   * HTML mechanisms such as inheritance and CSS rules.
   *
   * @param align the horizontal alignment ( {@link HasHorizontalAlignment#ALIGN_LEFT}, {@link
   *     HasHorizontalAlignment#ALIGN_CENTER}, {@link HasHorizontalAlignment#ALIGN_RIGHT}, {@link
   *     HasHorizontalAlignment#ALIGN_JUSTIFY}, {@link HasHorizontalAlignment#ALIGN_LOCALE_START},
   *     or {@link HasHorizontalAlignment#ALIGN_LOCALE_END}).
   */
