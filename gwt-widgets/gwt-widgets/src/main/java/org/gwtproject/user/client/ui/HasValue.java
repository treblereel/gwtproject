...
/**
 * Extends {@link TakesValue} to allow the value to be pulled back out, and to throw {@link
 * org.gwtproject.event.logical.shared.ValueChangeEvent ValueChangeEvent} events.
 *
 * <p>An object that implements this interface should be a user input widget, where the user and
 * programmer can both set and get the object's value. It is intended to provide a unified interface
 * to widgets with "atomic" values, like Strings and Dates.
 *
...
public interface HasValue<T> extends TakesValue<T>, HasValueChangeHandlers<T> {
   ...
   * (e.g. {@link CheckBox}) must find another valid meaning for null input.
   *
  ...
  /**
   * Sets this object's value. Fires {@link org.gwtproject.event.logical.shared.ValueChangeEvent}
