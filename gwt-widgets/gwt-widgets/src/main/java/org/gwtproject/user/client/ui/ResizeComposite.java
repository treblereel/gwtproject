...
/**
 * A {@link Composite} implementation that implements {@link RequiresResize} and automatically
 * delegates that interface's methods to its wrapped widget, which must itself implement {@link
 * RequiresResize}.
 */
