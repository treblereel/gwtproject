...
public abstract class MediaBase extends FocusWidget implements HasAllMediaHandlers {
  ...
  /**
   * Add a source element to this media. The browser will request source files from the server until
   * it finds one it can play.
   *
   * <p>Only use this method if you do not know the type of the source file, as the browser cannot
   * determine the format from the filename and must download each source until a compatible one is
   * found. Instead, you should specify the type for the media using {@link #addSource(String,
   * String)} so the browser can choose a source file without downloading the file.
   *
  ...
  /**
   * Add a source element to this media, specifying the type (format) of the media. The browser will
   * choose a supported source file and download it.
   *
   * <p>The type is the format or encoding of the media represented by the source element. For
   * example, the type of an {@link org.gwtproject.dom.client.AudioElement} could be one of {@value
   * org.gwtproject.dom.client.AudioElement#TYPE_OGG}, {@link
   * org.gwtproject.dom.client.AudioElement#TYPE_MP3}, or {@link
   * org.gwtproject.dom.client.AudioElement#TYPE_WAV}.
   *
   ...
   * @return one of {@link MediaElement#CAN_PLAY_PROBABLY}, {@link MediaElement#CAN_PLAY_MAYBE}, or
  ...
  /**
   * Returns the network state, one of {@link MediaElement#NETWORK_EMPTY}, {@link
   * MediaElement#NETWORK_IDLE}, {@link MediaElement#NETWORK_LOADING}, or {@link
  ...
  /**
   * Returns the preload setting, one of {@link MediaElement#PRELOAD_AUTO}, {@link
   * MediaElement#PRELOAD_METADATA}, or {@link MediaElement#PRELOAD_NONE}.
   *
   ...
   * as one of the constants {@link MediaElement#HAVE_CURRENT_DATA}, {@link
   * MediaElement#HAVE_ENOUGH_DATA}, {@link MediaElement#HAVE_FUTURE_DATA}, {@link
   * MediaElement#HAVE_METADATA}, or {@link MediaElement#HAVE_NOTHING} .
   *
  ...
  /**
   * Remove the specified {@link SourceElement} from this media. If the source element is not a
   * child of this widget, it will not be removed.
   *
  ...
  /**
   * Changes the preload setting to one of {@link MediaElement#PRELOAD_AUTO}, {@link
   * MediaElement#PRELOAD_METADATA}, or {@link MediaElement#PRELOAD_NONE}.
   *
   ...
   *
   * <p>Support for different media types varies between browsers. Instead of using this method, you
   * should encode your media in multiple formats and add all of them using {@link
   * #addSource(String, String)} so the browser can choose a source that it supports.
   *
   * @param url a String URL
   * @see #getSrc()
   * @see #addSource(String, String)
