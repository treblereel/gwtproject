...
public class ButtonCellBase_DefaultAppearance_ResourcesImpl
    implements ButtonCellBase.DefaultAppearance.Resources {
  private static ButtonCellBase_DefaultAppearance_ResourcesImpl _instance0 =
      new ButtonCellBase_DefaultAppearance_ResourcesImpl();
  ...
  private void buttonCellBaseStyleInitializer() {
    buttonCellBaseStyle =
        new ButtonCellBase.DefaultAppearance.Style() {
          ...
          public String getText() {
            return LocaleInfo.getCurrentLocale().isRTL()
                ? (".MU1SOAB-m-a{overflow:hidden;background:url("
                    + (ButtonCellBase_DefaultAppearance_ResourcesImpl.this
                        .buttonCellBaseBackground()
                        .getSafeUri()
                        .asString())
                    + ") "
  ...
  private static final String externalImage =
      "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAACAAAAAfCAYAAACGVs+MAAAAL0lEQVR4Xu3OMQ0AAAzDsPJnWwQbjD6OlN+5cWl7ywEAAAAAAAAAAAAAAAAA5oAHQZjT07gbmRUAAAAASUVORK5CYII=";
  ...
  public ResourcePrototype[] getResources() {
    return new ResourcePrototype[] {
      buttonCellBaseBackground(), buttonCellBaseStyle(),
    };
  }
