...
@J2clTestInput(CellTreeTest.class)
public class CellTreeTest extends AbstractCellTreeTestBase {
  ...
  /**
   * Test that CellTree handles rendering the same content, but with a different underlying value.
   */
  public void testRenderSameContent() {
    final AbstractCell<Integer> intCell =
  ...
  /**
   * Test that replacing a subset of children updates both the TreeNode value and the underlying DOM
   * correctly.
   */
  ...
  public void testExplicitKeyboardSelection() {
    ...
    assertTrue(
        CellTreeNodeView.getSelectionElement(l3View.getElement())
                .getClassName()
                .indexOf(cellTreeKeyboardSelectedItemStyleName)
            >= 0);
    ...
    assertTrue(
        CellTreeNodeView.getSelectionElement(l4View.getElement())
                .getClassName()
                .indexOf(cellTreeKeyboardSelectedItemStyleName)
            >= 0);
  ...
  public void testKeyboardNavigationForUpAndDownKeys() {
    ...
    List<String> expectedNavigationPath =
        Arrays.asList(
            "a", "aa", "ab", "ac", "ad", "ae", "af", "ag", "ah", "ai", "aj", "aja", "ajb", "ajc",
            "ajd", "aje", "ajf", "ajg", "ajh", "aji", "ajj", "b", "c", "d", "e", "f", "g", "h", "i",
            "j");
