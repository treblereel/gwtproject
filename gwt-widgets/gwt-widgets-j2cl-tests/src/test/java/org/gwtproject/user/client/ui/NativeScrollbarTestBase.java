 ...
 */
public abstract class NativeScrollbarTestBase<S extends AbstractNativeScrollbar>
  ...
  /**
   * Test that changing the scrollbar size can affect the scroll position and fires a scroll event.
   */
                    ...
                    .scheduleDeferred(
                        new ScheduledCommand() {
                          ...
                          public void execute() {
                            ...
                            final TestScrollHandler handler =
                                new TestScrollHandler() {
                                  @Override
