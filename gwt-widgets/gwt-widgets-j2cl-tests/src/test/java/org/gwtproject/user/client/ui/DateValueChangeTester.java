...
/** Handy tool for testing classes that implement {@link HasValue} of {@link Date}. */
public class DateValueChangeTester extends Assert {

  private final HasValue<Date> subject;

  /**
   * The HasValue<Date> to be tested. It should have been freshly created before handing it to this
   * tester.
   */
  ...
  /**
   * Asserts that the default value is null, checks that value change events do and don't fire when
   * appropriate, and that getValue() always returns what was handed to getValue().
   */
