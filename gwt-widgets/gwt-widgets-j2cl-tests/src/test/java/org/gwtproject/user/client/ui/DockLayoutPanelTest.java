...
public class DockLayoutPanelTest extends WidgetTestBase {
  ...
  public void testGetResolvedDirection() {
    ...
    assertEquals(Direction.WEST, panel.getResolvedDirection(Direction.LINE_START));
   ...
   */
  private void assertPhysicalPaternity(DockLayoutPanel panel, Widget expectedFirstChild) {
    assertSame(
  ...
  /**
   * Asserts that the {@link Direction} of <b>widget</b> in <b>panel</b> is
   * <b>expectedDirection</b>.
   *
   ...
   */
  private void assertWidgetDirection(
      DockLayoutPanel panel, Widget widget, Direction expectedDirection) {
    assertEquals(
        "The direction of the widget in the panel should be " + expectedDirection,
        expectedDirection,
