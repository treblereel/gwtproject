...
public class IconCellDecoratorTest extends CellTestBase<String> {
  ...
  public void testRenderNoImage() {
    ...
    IconCellDecorator<String> cell =
        new IconCellDecorator<String>(Resources.prettyPiccy(), innerCell) {
          @Override
    ...
    expected +=
        cell.getImageHtml(Resources.prettyPiccy(), HasVerticalAlignment.ALIGN_MIDDLE, true)
            .asString();
  ...
  public void testSelectableDelegate() {
    MockCell<String> innerCell = new MockCell<String>(true, "newValueFromInnerCell", "click");
    IconCellDecorator<String> iconCell =
        new IconCellDecorator<>(Resources.prettyPiccy(), innerCell);
  ...
  public void testSetValue() {
    ...
    assertEquals(
        "helloworld", Element.as(parent.getFirstChildElement().getChild(1)).getInnerHTML());
    Context context = new Context(0, 0, null);
