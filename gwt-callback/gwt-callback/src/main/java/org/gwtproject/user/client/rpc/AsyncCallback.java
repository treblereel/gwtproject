 ...
 *
 * <p>If an RPC is successful, then {@link #onSuccess(Object)} is called, otherwise {@link
 * #onFailure(Throwable)} is called.
 *
 * <p>Each callable asynchronous method corresponds to a method in the correlated service interface.
 * The asynchronous method always takes an <code>AsyncCallback&lt;T&gt;</code> as its last
 * parameter, where <code>T</code> is the return type of the correlated synchronous method.
 *
 * <p>As an example, suppose the service interface defines a method called <code>getShapes</code> as
 * follows:
 *
 * <pre>
 ...
 *
 * <p>A call with a typical use of <code>AsyncCallback</code> might look like this: <code>
 ...
 *     example, an <code>int</code> return type becomes an {@link Integer} type argument, and a
 *     <code>void</code> return type becomes a {@link Void} type argument, which is always <code>
 *     null</code>).
 */
public interface AsyncCallback<T> {
   ...
   * IncompatibleRemoteServiceExceptions, InvocationExceptions, or checked exceptions thrown by the
