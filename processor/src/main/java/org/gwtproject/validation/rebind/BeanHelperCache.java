...
public class BeanHelperCache { // public for testing
  ...
  public BeanHelper createHelper(Class<?> clazz, TreeLogger logger,
    ...
    throw new UnsupportedOperationException("createHelper");

/*    TypeElement beanType = context.getTypeOracle().findType(clazz.getCanonicalName());
  ...
  private BeanHelper doCreateHelper(TypeElement beanType, TreeLogger logger, GeneratorContext context)
    ...
    if (helper == null) {
      ...
      helper = new BeanHelper(beanType, bean);
