...
public class BeanHelperCache { // public for testing
  ...
  private BeanHelper doCreateHelper(
      TypeElement beanType, TreeLogger logger, GeneratorContext context)
      throws UnableToCompleteException {
  ...
  private void doCreateHelperForProp(
      PropertyDescriptor p, BeanHelper parent, TreeLogger logger, GeneratorContext context)
      throws UnableToCompleteException {
  ...
  /**
   * Write an Empty Interface implementing {@link
   * org.gwtproject.validation.client.impl.GwtSpecificValidator} with Generic parameter of the bean
   * type.
   */
