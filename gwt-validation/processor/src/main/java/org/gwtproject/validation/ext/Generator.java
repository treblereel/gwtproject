 ...
 * the License.
 */
package org.gwtproject.validation.ext;
 ...
 * thread-safe.
 *
 * <p>If annotated by {@code @RunsLocal}, a generator can minimize its impact on compilation speed.
 * See {@link RunsLocal} for details.
 *
...
public abstract class Generator {
   ...
   *
   * @return the name of a subclass to substitute for the requested class, or return <code>null
   *     </code> to cause the requested type itself to be used
   */
  public abstract String generate(TreeLogger logger, GeneratorContext context, TypeElement typeName)
