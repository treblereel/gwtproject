...
public interface ElementDescriptor {
  ...
  /**
   * Declare restrictions on retrieved constraints. Restrictions are cumulative.
   *
   * <p>A <code>ConstraintFinder</code> is not thread-safe. The set of matching <code>
   * ConstraintDescriptor</code> is.
   */
  interface ConstraintFinder {
    /**
     * Restrict to the constraints matching a given set of groups for this element
     *
     * <p>This method respects group sequences and group inheritance (including class-level <code>
     * Default</code> group overriding) but does not return <code>ConstraintDescriptor</code>s in
     * any particular order. Specifically, ordering of the group sequence is not respected.
     *
     ...
     *
     * <p>Defaults to <code>Scope.HIERARCHY</code>
     *
    ...
    /**
     * Restrict to the constraints hosted on the listed <code>types</code> for a given element.
     *
     * <p>Default to all possible types of the element.
     *
     * <p>Typically used to restrict to fields (<code>FIELD</code>) or getters (<code>METHOD</code>)
     *
    ...
    /**
     * Retrieve the constraint descriptors following the defined restrictions and hosted on the
     * element described by <code>ElementDescriptor</code>
     *
    ...
    /**
     * Returns <code>true</code> if at least one constraint declaration matching the restrictions is
