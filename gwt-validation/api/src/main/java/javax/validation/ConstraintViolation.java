...
/**
 * Describe a constraint violation. This object exposes the constraint violation context as well as
...
public interface ConstraintViolation<T> {
  ...
  /**
   * @return The root bean being validated. Null when returned by {@link
   *     javax.validation.Validator#validateValue(Class, String, Object, Class[])}
   */
  T getRootBean();
   ...
   *
   * @return the leaf bean the constraint is applied on. Null when returned by {@link
   *     javax.validation.Validator#validateValue(Class, String, Object, Class[])}
   */
  Object getLeafBean();
