...
/**
 * The annotated element must be a number whose value must be higher or equal to the specificed
 * minimum.
 *
...
public @interface DecimalMin {
  ...
  /**
   * The <code>String</code> representation of the min value according to the <code>BigDecimal
