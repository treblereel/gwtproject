...
/**
 * Factory returning initialized <code>Validator</code> instances. Implementations are thread-safe
...
public interface ValidatorFactory {
  /**
   * Returns an initialized <code>Validator</code> instance using the factory defaults for message
  ...
  /**
   * Defines a new validator context and return a <code>Validator</code> compliant this new context.
   *
