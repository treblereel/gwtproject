...
public class ZoneRulesBuilderTestWrapper {
  ...
  public ZoneRulesBuilderTestWrapper addWindow(
  ...
  public ZoneRulesBuilderTestWrapper addRuleToWindow(
      LocalDateTime transitionDateTime, TimeDefinition timeDefinition, int savingAmountSecs) {
    ZoneRulesBuilders.addRuleToWindow(
        builder, transitionDateTime, timeDefinition, savingAmountSecs);
    return this;
  }
