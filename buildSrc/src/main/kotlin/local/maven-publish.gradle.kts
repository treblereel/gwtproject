...
val mavenPublication = publishing.publications.create<MavenPublication>("maven") {
    ...
    pom {
        ...
        url.set("https://github.com/gwtproject/gwt-history")
        developers {
            developer {
        ...
        scm {
            connection.set("https://github.com/gwtproject/gwt-history.git")
            developerConnection.set("scm:git:ssh://github.com:gwtproject/gwt-history.git")
            url.set("https://github.com/gwtproject/gwt-history")
        }
        licenses {
            license {
