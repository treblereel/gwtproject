...
val mavenPublication = publishing.publications.create<MavenPublication>("maven") {
    ...
    pom {
        ...
        url.set("https://github.com/gwtproject/gwt-window")
        developers {
            developer {
        ...
        scm {
            connection.set("https://github.com/gwtproject/gwt-window.git")
            developerConnection.set("scm:git:ssh://github.com:gwtproject/gwt-window.git")
            url.set("https://github.com/gwtproject/gwt-window")
        }
        licenses {
            license {
