...
/**
 * Parses widgets that inherit from HasAlignment. This class is needed to resolve the parse order of
 * alignment attributes for these classes.
 *
 * <p>See {@link "http://code.google.com/p/google-web-toolkit/issues/detail?id=5518"} for issue
 * details.
 */
public class HasAlignmentParser implements ElementParser {
  ...
  public void parse(XMLElement elem, String fieldName, TypeMirror type, UiBinderWriter writer)
    ...
    String horizontalAlignment =
        elem.consumeAttributeWithDefault("horizontalAlignment", null, hAlignConstantType.asType());
    ...
    String verticalAlignment =
        elem.consumeAttributeWithDefault("verticalAlignment", null, vAlignConstantType.asType());
