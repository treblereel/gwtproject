...
public class AnyRtlDirectionEstimatorTest extends DirectionEstimatorTestBase {
  ...
  protected void assertDirectionEstimation(
    ...
    assertDirectionEstimation(expectedDirection, AnyRtlDirectionEstimator.get(), str, isHtml);
  }

  private final String containsRtlChar = EN_WORD + DIGITS_WORD + WORD_WITH_ONE_RTL_CHAR;
