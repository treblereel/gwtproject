...
public class FirstStrongDirectionEstimatorTest extends DirectionEstimatorTestBase {
  ...
  protected void assertDirectionEstimation(
    ...
    assertDirectionEstimation(expectedDirection, FirstStrongDirectionEstimator.get(), str, isHtml);
  }
  ...
  private String firstStrongRtlHtml = DIGITS_WORD + LONG_LTR_TAG + IW_WORD + EN_WORD;
