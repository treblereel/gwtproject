 ...
 *
 * <p>This works by setting the key generator to MD5 on this interface, then verifying that keys in
 * the subinterface are looked up with MD5 hashes rather than method names.
 */
