...
public class I18N_en_US_Test extends GWTTestCase {
  ...
  public void testMultiSelectEnum() {
    ...
    assertEquals(
        ...
        m.multiSelectEnum(
            ...
            .asString());
    assertEquals(
        "test: Nobody liked his 2 messages",
        m.multiSelectEnum(
                names,
                names.size() > 0 ? names.get(0) : null,
                names.size() > 1 ? names.get(1) : null,
    ...
    assertEquals(
        ...
        m.multiSelectEnum(
            ...
            .asString());
    assertEquals(
        "test: Nobody liked her 3 messages",
        m.multiSelectEnum(
                names,
                names.size() > 0 ? names.get(0) : null,
                names.size() > 1 ? names.get(1) : null,
            ...
            .asString());
    assertEquals(
        "test: Nobody liked their message",
        m.multiSelectEnum(
                names,
                names.size() > 0 ? names.get(0) : null,
                names.size() > 1 ? names.get(1) : null,
            ...
            .asString());
    assertEquals(
        "test: Nobody liked their 4 messages",
        m.multiSelectEnum(
                names,
                names.size() > 0 ? names.get(0) : null,
                names.size() > 1 ? names.get(1) : null,
    ...
    assertEquals(
        ...
        m.multiSelectEnum(
            ...
            .asString());
    assertEquals(
        "test: John liked his 2 messages",
        m.multiSelectEnum(
                names,
                names.size() > 0 ? names.get(0) : null,
                names.size() > 1 ? names.get(1) : null,
    ...
    assertEquals(
        ...
        m.multiSelectEnum(
            ...
            .asString());
    assertEquals(
        "test: John liked her 3 messages",
        m.multiSelectEnum(
                names,
                names.size() > 0 ? names.get(0) : null,
                names.size() > 1 ? names.get(1) : null,
    ...
    assertEquals(
        ...
        m.multiSelectEnum(
            ...
            .asString());
    assertEquals(
        "test: John liked their 4 messages",
        m.multiSelectEnum(
                names,
                names.size() > 0 ? names.get(0) : null,
                names.size() > 1 ? names.get(1) : null,
    ...
    names.add("Bob");
    assertEquals(
        "test: John and Bob liked his message",
        m.multiSelectEnum(
                names,
                names.size() > 0 ? names.get(0) : null,
                names.size() > 1 ? names.get(1) : null,
            ...
            .asString());
    assertEquals(
        "test: John and Bob liked his 2 messages",
        m.multiSelectEnum(
                names,
                names.size() > 0 ? names.get(0) : null,
                names.size() > 1 ? names.get(1) : null,
            ...
            .asString());
    assertEquals(
        "test: John and Bob liked her message",
        m.multiSelectEnum(
                names,
                names.size() > 0 ? names.get(0) : null,
                names.size() > 1 ? names.get(1) : null,
            ...
            .asString());
    assertEquals(
        "test: John and Bob liked her 3 messages",
        m.multiSelectEnum(
                names,
                names.size() > 0 ? names.get(0) : null,
                names.size() > 1 ? names.get(1) : null,
            ...
            .asString());
    assertEquals(
        "test: John and Bob liked their message",
        m.multiSelectEnum(
                names,
                names.size() > 0 ? names.get(0) : null,
                names.size() > 1 ? names.get(1) : null,
            ...
            .asString());
    assertEquals(
        "test: John and Bob liked their 4 messages",
        m.multiSelectEnum(
                names,
                names.size() > 0 ? names.get(0) : null,
                names.size() > 1 ? names.get(1) : null,
    ...
    names.add("Alice");
    assertEquals(
        "test: John, Bob, and one other liked his message",
        m.multiSelectEnum(
                names,
                names.size() > 0 ? names.get(0) : null,
                names.size() > 1 ? names.get(1) : null,
            ...
            .asString());
    assertEquals(
        "test: John, Bob, and one other liked his 2 messages",
        m.multiSelectEnum(
                names,
                names.size() > 0 ? names.get(0) : null,
                names.size() > 1 ? names.get(1) : null,
            ...
            .asString());
    assertEquals(
        "test: John, Bob, and one other liked her message",
        m.multiSelectEnum(
                names,
                names.size() > 0 ? names.get(0) : null,
                names.size() > 1 ? names.get(1) : null,
            ...
            .asString());
    assertEquals(
        "test: John, Bob, and one other liked her 3 messages",
        m.multiSelectEnum(
                names,
                names.size() > 0 ? names.get(0) : null,
                names.size() > 1 ? names.get(1) : null,
            ...
            .asString());
    assertEquals(
        "test: John, Bob, and one other liked their message",
        m.multiSelectEnum(
                names,
                names.size() > 0 ? names.get(0) : null,
                names.size() > 1 ? names.get(1) : null,
            ...
            .asString());
    assertEquals(
        "test: John, Bob, and one other liked their 4 messages",
        m.multiSelectEnum(
                names,
                names.size() > 0 ? names.get(0) : null,
                names.size() > 1 ? names.get(1) : null,
    ...
    names.add("Carol");
    assertEquals(
        "test: John, Bob, and 2 others liked his message",
        m.multiSelectEnum(
                names,
                names.size() > 0 ? names.get(0) : null,
                names.size() > 1 ? names.get(1) : null,
            ...
            .asString());
    assertEquals(
        "test: John, Bob, and 2 others liked his 2 messages",
        m.multiSelectEnum(
                names,
                names.size() > 0 ? names.get(0) : null,
                names.size() > 1 ? names.get(1) : null,
            ...
            .asString());
    assertEquals(
        "test: John, Bob, and 2 others liked her message",
        m.multiSelectEnum(
                names,
                names.size() > 0 ? names.get(0) : null,
                names.size() > 1 ? names.get(1) : null,
            ...
            .asString());
    assertEquals(
        "test: John, Bob, and 2 others liked her 3 messages",
        m.multiSelectEnum(
                names,
                names.size() > 0 ? names.get(0) : null,
                names.size() > 1 ? names.get(1) : null,
            ...
            .asString());
    assertEquals(
        "test: John, Bob, and 2 others liked their message",
        m.multiSelectEnum(
                names,
                names.size() > 0 ? names.get(0) : null,
                names.size() > 1 ? names.get(1) : null,
            ...
            .asString());
    assertEquals(
        "test: John, Bob, and 2 others liked their 4 messages",
        m.multiSelectEnum(
                names,
                names.size() > 0 ? names.get(0) : null,
                names.size() > 1 ? names.get(1) : null,
  ...
  public void testSpecialPlurals() {
    ...
    assertEquals(
        "test: John Doe and Betty Smith have reviewed this movie",
    ...
    assertEquals(
        "test: John Doe has reviewed this movie",
        m.reviewersAsSafeHtml(1, "test: John Doe", null).asString());
    assertEquals(
        "test: John Doe and Betty Smith have reviewed this movie",
