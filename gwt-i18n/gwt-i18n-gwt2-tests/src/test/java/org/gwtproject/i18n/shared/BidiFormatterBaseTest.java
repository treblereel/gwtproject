...
public class BidiFormatterBaseTest extends TestCase {
  ...
  public static class TestableBidiFormatterBase extends BidiFormatterBase {
    static class Factory extends BidiFormatterBase.Factory<TestableBidiFormatterBase> {
      @Override
      public TestableBidiFormatterBase createInstance(Direction contextDir, boolean alwaysSpan) {
    ...
    public static TestableBidiFormatterBase getInstance(Direction contextDir, boolean alwaysSpan) {
  ...
  String longHe = "\u05e0 \u05e1 \u05e0 ";
  BidiFormatterBase ltrFmt = TestableBidiFormatterBase.getInstance(LTR, false); // LTR context
  BidiFormatterBase rtlFmt = TestableBidiFormatterBase.getInstance(RTL, false); // RTL context
  BidiFormatterBase unkFmt =
      TestableBidiFormatterBase.getInstance(DEFAULT, false); // DEFAULT context
  ...
  public void testGetInstance() {
    ...
    assertEquals(ltrFmt, TestableBidiFormatterBase.getInstance(LTR, false));
    assertEquals(rtlFmt, TestableBidiFormatterBase.getInstance(RTL, false));
    assertEquals(unkFmt, TestableBidiFormatterBase.getInstance(DEFAULT, false));
    assertEquals(ltrAlwaysSpanFmt, TestableBidiFormatterBase.getInstance(LTR, true));
    assertEquals(rtlAlwaysSpanFmt, TestableBidiFormatterBase.getInstance(RTL, true));
    assertEquals(unkAlwaysSpanFmt, TestableBidiFormatterBase.getInstance(DEFAULT, true));
  }
  ...
  public void testSpanWrapBase() {
    ...
    assertEquals("<span dir=rtl>" + he + "</span>" + LRM, ltrFmt.spanWrapBase(he, true, true));
    assertEquals(he, rtlFmt.spanWrapBase(he, true, true));
    assertEquals("<span dir=ltr>" + en + "</span>" + RLM, rtlFmt.spanWrapBase(en, true, true));
    assertEquals(en, ltrFmt.spanWrapBase(en, true, true));
  }

  public void testSpanWrapWithKnownDirBase() {
    assertEquals(
        "overall dir matches context dir (LTR)",
        en + "&lt;",
        ltrFmt.spanWrapWithKnownDirBase(LTR, en + "<", false, true));
    assertEquals(
        "overall dir matches context dir (LTR), HTML",
        en + "<br>",
        ltrFmt.spanWrapWithKnownDirBase(LTR, en + "<br>", true, true));
    assertEquals(
        "overall dir matches context dir (RTL)",
        he + "&lt;",
        rtlFmt.spanWrapWithKnownDirBase(RTL, he + "<", false, true));
    assertEquals(
        "overall dir matches context dir (RTL), HTML",
        he + " <some strange tag>",
        rtlFmt.spanWrapWithKnownDirBase(RTL, he + " <some strange tag>", true, true));
    ...
    assertEquals(
        "plain text overall and exit dir same as context dir",
        "&lt;br&gt; " + he + " &lt;br&gt;",
        ltrFmt.spanWrapWithKnownDirBase(LTR, "<br> " + he + " <br>", false, true));
    assertEquals(
        "HTML overall and exit dir opposite to context dir",
        "<span dir=rtl><br> " + he + " <br></span>" + LRM,
        ltrFmt.spanWrapWithKnownDirBase(RTL, "<br> " + he + " <br>", true, true));
    ...
    assertEquals(
        ...
        "<span>&lt;br&gt; " + he + " &lt;br&gt;</span>",
        ltrAlwaysSpanFmt.spanWrapWithKnownDirBase(LTR, "<br> " + he + " <br>", false, true));
    assertEquals(
        "alwaysSpan, HTML overall and exit dir opposite to context dir",
        "<span dir=rtl><br> " + he + " <br></span>" + LRM,
        ltrAlwaysSpanFmt.spanWrapWithKnownDirBase(RTL, "<br> " + he + " <br>", true, true));
  }
  ...
  public void testUnicodeWrapWithKnownDirBase() {
    ...
    assertEquals(
        "overall dir matches context dir (RTL), HTML",
        he + " <some strange tag>",
        rtlFmt.unicodeWrapWithKnownDirBase(RTL, he + " <some strange tag>", true, true));
    ...
    assertEquals(
        "plain text overall and exit dir same as context dir",
        html + " " + he + " " + html,
        ltrFmt.unicodeWrapWithKnownDirBase(LTR, html + " " + he + " " + html, false, true));
    assertEquals(
        "HTML overall and exit dir opposite to context dir",
