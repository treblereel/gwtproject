...
public interface TestAnnotatedMessages extends Messages {
   ...
   *
   * <p>nestedDollar() is redefined in a property file with a $ in it. nestedUnderscore() is
   * redefined in a property file with a _ in it.
   */
  @Message
  ...
  String multiSelectString(
      @PluralCount @Offset(2) List<String> names,
      String name1,
      String name2,
      @PluralCount int msgCount,
  ...
  @DefaultMessage("{0} widgets")
  @AlternateMessage({"=0", "No widgets", "=1", "A widget", "one", "{0} widget"})
  ...
  String reviewers(@PluralCount @Offset(2) int size, String name1, String name2);
  ...
  @Key("reviewers")
  SafeHtml reviewersAsSafeHtml(@PluralCount @Offset(2) int size, String name1, SafeHtml name2);
