...
/**
 * Unit tests for {@link BidiFormatter}. Tests only methods added in {@code BidiFormatter}, i.e.
...
public class BidiFormatterTest extends TestCase {
  ...
  public void testDirAttr() {
    ...
    assertEquals(
        "dirAttr(String, boolean)", "dir=rtl", ltrFormatter.dirAttr(he + longHtmlTag, true));
  }
  ...
  public void testGetInstance() {
    ...
    assertEquals(DEFAULT, BidiFormatter.getInstance(DEFAULT).getContextDir());
  ...
  public void testMarkAfter() {
    assertEquals("markAfter(String)", LRM_STRING, ltrFormatter.markAfter(longEn + he));
    assertEquals(
        "markAfter(String, boolean)",
        LRM_STRING,
  ...
  public void testSpanWrap() {
    ...
    assertEquals(
        "spanWrap(String, boolean)",
        "<span dir=rtl>" + he + longHtmlTag + "</span>" + LRM,
        ltrFormatter.spanWrap(he + longHtmlTag, true));
    assertEquals(
        "spanWrap(String, boolean, boolean)",
        "<span dir=rtl>" + he + longHtmlTag + "</span>",
        ltrFormatter.spanWrap(he + longHtmlTag, true, false));
  }
  ...
  public void testSpanWrapWithKnownDir() {
    ...
    assertEquals(
        "spanWrapWithKnownDir(Direction, String, boolean, boolean)",
  ...
  public void testUnicodeWrap() {
    assertEquals("unicodeWrap(String)", RLE + he + PDF + LRM, ltrFormatter.unicodeWrap(he));
    assertEquals(
        "unicodeWrap(String, boolean)",
        RLE + he + longHtmlTag + PDF + LRM,
        ltrFormatter.unicodeWrap(he + longHtmlTag, true));
    assertEquals(
        "unicodeWrap(String, boolean, boolean)",
        RLE + he + longHtmlTag + PDF,
        ltrFormatter.unicodeWrap(he + longHtmlTag, true, false));
  }

  public void testUnicodeWrapWithKnownDir() {
    assertEquals(
        "unicodeWrapWithKnownDir(Direction, String)",
        RLE + en + PDF + LRM,
        ltrFormatter.unicodeWrapWithKnownDir(RTL, en));
    assertEquals(
        "unicodeWrapWithKnownDir(Direction, String, boolean)",
        RLE + en + longHtmlTag + PDF + LRM,
        ltrFormatter.unicodeWrapWithKnownDir(RTL, en + longHtmlTag, true));
    assertEquals(
        "unicodeWrapWithKnownDir(Direction, String, boolean, boolean)",
        RLE + en + longHtmlTag + PDF,
        ltrFormatter.unicodeWrapWithKnownDir(RTL, en + longHtmlTag, true, false));
  }
}
