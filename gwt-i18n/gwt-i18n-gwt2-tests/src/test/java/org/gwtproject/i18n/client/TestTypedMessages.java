...
public interface TestTypedMessages extends Messages {
  ...
  /**
   * testAllTypes = int({0}) float({1}), long({2}), boolean({3}), Object({4}, char({5}), byte({6}),
   * short({7});.
   */
  String testAllTypes(int a, float f, long l, boolean bool, Object obj, char c, byte b, short s);

  @Key("testAllTypes")
  SafeHtml testAllTypesAsSafeHtml(
      int a, float f, long l, boolean bool, Object obj, char c, byte b, short s);
  ...
  String testSomeObjectTypes(Object test, StringBuffer buf, Integer i, Object giveMeANull);

  @Key("testSomeObjectTypes")
  SafeHtml testSomeObjectTypesAsSafeHtml(
      Object test, StringBuffer buf, Integer i, Object giveMeANull);
