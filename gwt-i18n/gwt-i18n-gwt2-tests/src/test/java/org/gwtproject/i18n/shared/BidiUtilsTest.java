...
/**
 * Unit tests for BidiUtils. Uses the pure Java implementation of {@link
 * com.google.gwt.regexp.shared.RegExp}. {@link GwtBidiUtilsTest} performs all the tests using the
 * GWT version of RegExp. This is needed due to several differences between the two implementations
 * of RegExp (see {@link com.google.gwt.regexp.shared.RegExpTest} for details).
 */
public class BidiUtilsTest extends TestCase {
  ...
  public void testEstimateDirection() {
    ...
    assertEquals(
        Direction.RTL,
        bidiUtils.estimateDirection(
            "\u05d4\u05d3\u05dc\u05ea http://www.google.com " + "http://www.gmail.com", false));
    assertEquals(
        Direction.LTR,
        bidiUtils.estimateDirection(
    ...
    assertEquals(
        Direction.LTR,
        bidiUtils.estimateDirection("\u05d4\u05d3\u05dc\u05ea &amp; &lt; &gt;", false));
    assertEquals(
        Direction.RTL,
        bidiUtils.estimateDirection("\u05d4\u05d3\u05dc\u05ea &amp; &lt; &gt;", true));
  }
