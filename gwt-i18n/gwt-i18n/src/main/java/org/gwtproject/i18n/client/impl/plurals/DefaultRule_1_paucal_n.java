...
/**
 * Common plural rule for languages that have singular, two plural forms (based on the units and
 * tens digits) and a fractional form ("other").
 *
 * <p>Polish is the only language that uses this plural rule.
 *
 * <p>Note: Perhaps this class should have been named: DefaultRule_1_x234_n
 *
