...
public final class CurrencyDataImpl extends DefaultCurrencyData {
  ...
  /**
   * Public so CurrencyListGenerator can get to them. As usual with an impl package, external code
  ...
  public CurrencyDataImpl(
    ...
    super(currencyCode, currencySymbol, getDefaultFractionDigits(flagsAndPrecision));
    this.flagsAndPrecision = flagsAndPrecision;
    this.portableCurrencySymbol =
        portableCurrencySymbol == null ? currencySymbol : portableCurrencySymbol;
    this.simpleCurrencySymbol =
        simpleCurrencySymbol == null ? currencySymbol : simpleCurrencySymbol;
  }
