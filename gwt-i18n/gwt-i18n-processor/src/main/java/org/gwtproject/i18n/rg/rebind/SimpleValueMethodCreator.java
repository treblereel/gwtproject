...
class SimpleValueMethodCreator extends AbstractLocalizableMethodCreator {
  ...
  static final AbstractValueCreator DOUBLE =
      new AbstractValueCreator() {
        @Override
        String getValue(String stringVal) {
          return Double.parseDouble(stringVal) + "";
        }
      };
  static final AbstractValueCreator FLOAT =
      new AbstractValueCreator() {
        @Override
        String getValue(String stringVal) {
  ...
  static final AbstractValueCreator INT =
      new AbstractValueCreator() {
        @Override
        String getValue(String stringVal) {
  ...
  static final AbstractValueCreator STRING =
      new AbstractValueCreator() {
        @Override
        String getValue(String stringVal) {
  ...
  static final AbstractValueCreator BOOLEAN =
      new AbstractValueCreator() {
        @Override
        String getValue(String stringVal) {
  ...
  SimpleValueMethodCreator(
      AbstractGeneratorClassCreator currentCreator, AbstractValueCreator valueCreator) {
  ...
  public void createMethodFor(
    ...
    System.out.println(
        "   createMethodFor " + targetMethod + " " + key + " " + value + " " + locale);
    ...
    try {
      ...
      throw error(
          logger,
          "'" + value + "' is not a valid boolean property value; must be 'true' or 'false'");
    }
  }
}
