...
public class MessageFormatUtils {
  ...
  public enum MessageStyle {
     ...
     * @throws VisitorAbortException
     */
    public abstract String assemble(List<TemplateChunk> message) throws VisitorAbortException;
     ...
     */
    public abstract List<TemplateChunk> parse(String template) throws ParseException;
  ...
  public abstract static class TemplateChunk {
    ...
    public abstract void accept(TemplateChunkVisitor visitor) throws VisitorAbortException;
