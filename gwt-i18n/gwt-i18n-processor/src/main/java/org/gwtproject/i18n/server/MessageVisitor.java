...
public interface MessageVisitor {
   ...
   *
   * <p>Note that the default message will always be passed in a call to this method, even if there
   * are no selectors.
   *
   * @param formNames array of form names, one for each selector
   * @param isDefault true if this is the default message (ie, all forms are "other")
   * @param style
   * @param msg
   * @throws MessageProcessingException
   */
  void visitTranslation(String[] formNames, boolean isDefault, MessageStyle style, String msg)
      throws MessageProcessingException;
}
