...
public interface CodeGenContext {
  ...
  /**
   * An exception which can be thrown by a code generator to abort - callers of code generators
   ...
   * @param pkgName
   * @param className
   * @return a {@link JavaSourceWriterBuilder} for the requested class or null if it could not be
   *     created, such as if it already exists
   */
