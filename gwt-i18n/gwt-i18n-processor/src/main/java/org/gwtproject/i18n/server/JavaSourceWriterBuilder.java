...
public class JavaSourceWriterBuilder {
   ...
   * @param className
   */
  public JavaSourceWriterBuilder(
  ...
  /**
   * Creates an implementation of {@link JavaSourceWriter} that can be used to write the innards of
   * a class. Note that the subsequent changes to this factory do not affect the returned instance.
   *
