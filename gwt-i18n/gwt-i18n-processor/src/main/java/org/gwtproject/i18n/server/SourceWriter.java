...
public interface SourceWriter {
  ...
  /**
   * Print a line at an increased indentation level without altering the indent level for the next
   * line.
   *
   * @param string
   */
  ...
  /**
   * Format and print a line at an increased indentation level without altering the indent level for
   * the next line.
   *
