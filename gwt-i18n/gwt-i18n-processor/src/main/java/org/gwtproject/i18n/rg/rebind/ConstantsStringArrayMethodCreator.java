...
class ConstantsStringArrayMethodCreator extends AbstractLocalizableMethodCreator {
   ...
   * @param classCreator
   */
  public ConstantsStringArrayMethodCreator(AbstractGeneratorClassCreator classCreator) {
    super(classCreator);
  }
  ...
  public void createMethodFor(
      ...
      String key,
      AbstractResource.ResourceList resource,
      GwtLocale locale) {
