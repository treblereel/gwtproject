...
public abstract class StringGenerator {
   ...
   * @param isSafeHtmlTyped true if the expression is known to be of type {@link SafeHtml SafeHtml};
   *     only relevant if this generator has been initialized to generate a {@link SafeHtml
   *     SafeHtml}-valued expression
   * @param isPrimitiveTyped true if the expression is of a primitive type; only relevant if this
   *     generator has been initialized to generate a {@link SafeHtml SafeHtml}-valued expression
   * @param needsConversionToString true if the expression is not known to be of type String and
