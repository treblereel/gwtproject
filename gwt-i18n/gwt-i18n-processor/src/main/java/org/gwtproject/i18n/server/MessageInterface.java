...
public interface MessageInterface {
  ...
  /**
   * Get the unqualified class name (including parent classes for nested classes - ie, "Foo.Bar") of
   * this {@link MessageInterface}.
   *
  ...
  /**
   * Get the fully qualified source name (ie, "org.example.Foo.Bar": if Bar is an inner class of
   * Foo) of this message interface - generally used for error messages.
   *
