...
/** A <code>AbstractMethodCreator</code> specialized for <code>ConstantsImplCreator</code>. */
abstract class AbstractLocalizableMethodCreator extends AbstractMethodCreator {
   ...
   */
  public AbstractLocalizableMethodCreator(AbstractGeneratorClassCreator classCreator) {
    super(classCreator);
  }
