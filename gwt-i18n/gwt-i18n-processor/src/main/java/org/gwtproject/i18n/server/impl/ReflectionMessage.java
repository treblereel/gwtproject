...
/**
 * Implementation of {@link Message Message} using reflection.
 *
 * <p><b>NOTE: THIS CLASS IS CURRENTLY ONLY SUITABLE FOR TESTING OR IF YOU DON'T CARE ABOUT ACCURATE
 * ARGUMENT NAMES</b>
 */
public class ReflectionMessage extends AbstractMessage {
  ...
  private class ReflectionParameter extends AbstractParameter {
    ...
    public String getName() {
      String[] names =
          ((ReflectionMessageInterface) getMessageInterface()).getParameterNames(method);
      if (names != null) {
  ...
  public boolean isAnnotationPresent(Class<? extends Annotation> annotClass) {
    ...
    return ReflectionUtils.getAnnotation(method.getDeclaringClass(), annotClass, true) != null;
  }
