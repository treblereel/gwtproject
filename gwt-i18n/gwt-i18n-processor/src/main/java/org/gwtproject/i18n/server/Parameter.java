...
public interface Parameter {
  ...
  /**
   * Get an {@link AlternateMessageSelector} instance associated with this parameter, or null if
   * none.
   *
  ...
  /**
   * Get the name of this parameter. Note that this may be expensive (ie, if based on reflection
   * this will require reading/parsing source), so this should only be called if actually needed.
   *
   * @return parameter name, or "arg" + {@link #getIndex()} if it cannot be determined
   */
  String getName();
