...
/** Reflection-based implementation of {@link MessageInterface MessageInterface}. */
public class ReflectionMessageInterface extends AbstractMessageInterface {
  ...
  public ReflectionMessageInterface(
      AptContext context, GwtLocaleFactory factory, Class<? extends LocalizableResource> msgIntf) {
    super(factory);
  ...
  public Iterable<Message> getMessages() throws MessageProcessingException {
    ...
    for (Method method : methods) {
      messages.add(
          new ReflectionMessage(context, factory, ReflectionMessageInterface.this, method));
    }
