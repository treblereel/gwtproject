 ...
 *
 * <p>The general calling sequence of methods on this visitor and sub-visitors should be, for
 ...
 * </pre>
 *
 * Visitors that are interested in knowing when particular selectors and their form values begin/end
 * should see {@link FormVisitorDriver}.
 */
public interface MessageInterfaceVisitor {
   ...
   *
   * @return a {@link MessageVisitor} instance which will be used to visit the supplied message, or
