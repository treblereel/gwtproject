...
/**
 * A default visitor implementation which does nothing and returns itself for sub-visitors. Most
 * implementations should subclass this class and override individual methods as needed for future
 * compatibility.
 */
public class DefaultVisitor implements MessageInterfaceVisitor, MessageVisitor {
  ...
  public void visitTranslation(
      String[] formNames, boolean isDefault, MessageFormatUtils.MessageStyle style, String msg)
      throws MessageProcessingException {
    // do nothing by default
  }
}
