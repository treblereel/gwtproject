...
/**
 * Creates method factories depending upon the method type. Includes the core concrete
 * implementations as package-protected classes to avoid cluttering up the package space.
 */
public abstract class AbstractMethodCreator extends AbstractSourceCreator {
   ...
   */
  public abstract void createMethodFor(
      TreeLogger logger,
