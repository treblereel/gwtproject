...
/**
 * Wrapper for a {@link PrintWriter} that adds the ability to abort creation and an onClose hook
 *
...
public class AbortablePrintWriter extends PrintWriter {
   ...
   *
   * @param pw
   * @throws RuntimeException if there are reflection errors accessing the out field in pw
   */
