...
public abstract class AbstractMessage implements Message {
  ...
  public AbstractMessage(
      AptContext context, GwtLocaleFactory localeFactory, MessageInterface msgIntf) {
  ...
  public String getKey() {
    ...
    if (key == null) {
      ...
      throw new RuntimeException(
          "null key on "
              + getMessageInterface().getQualifiedName()
              + "."
              + getMethodName()
              + ", @GenerateKeys="
              + keyGenAnnot
  ...
  protected void addMapping(
      List<AlternateFormMapping> mapping, int numSelectors, String joinedForms, String msg) {
  ...
  /**
   * Get the alternate message forms from either an AlternateMessages annotation or a PluralText
   * annotation.
   */
  ...
  protected String[] getAlternateMessages() {
    ...
    PluralText pluralTextAnnot = getAnnotation(PluralText.class);
  ...
  protected GwtLocale getDefaultLocale() {
    ...
    String defLocale =
        defLocaleAnnot != null ? defLocaleAnnot.value() : DefaultLocale.DEFAULT_LOCALE;
  ...
  /**
   * Called by subclasses to complete initialization, after ensuring that calls to {@link
  ...
  private void processStringMap(DefaultStringMapValue dsmv) {
    ...
    overrideDefault =
        new StringMapMessageTranslation(defaultMessage, sortedKeys, map, matchedLocale);
  }
}
